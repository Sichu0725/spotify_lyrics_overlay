  ...
  def run(self):
    while True :
      ...
      if track_info is not None:
        ...
        device = track_info['device']['name'] # current playing device
        song = track_info['item']['name'] # song name
        song_id = track_info['item']['id'] # song's unique id
        artist = track_info['item']['artists'][0]['name'] # only get the first artist
        album = track_info['item']['album']['name'] # alubm name
        ...
        while is_daemon:
          ...
          while is_playing:
            ...
            try :
              ...
              pass
            if int(lyrics[idx]['startTimeMs']) < int(progress_ms): # 같은 시간대 
